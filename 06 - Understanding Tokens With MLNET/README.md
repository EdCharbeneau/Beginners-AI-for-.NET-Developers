...
```
06 - Understanding Tokens With MLNET
├── 6.2 - Connecting the token 
|   ├── 6.2 - Connecting the token visualizer.slnx
│   ├── Connecting the token visualizer - Start 
│   └── Connecting the token visualizer - End
└── 6.3 - Performing tokenization and reviewing the output
    ├── 6.3 - Performing tokenization and reviewing the output.slnx
    ├── Performing tokenization and reviewing the output - Start
    └── Performing tokenization and reviewing the output - End
```